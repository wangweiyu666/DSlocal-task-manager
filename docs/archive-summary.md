...
- W33 在本归档基线之后新增 UI 配色选择，并纳入 `v0.1.0-alpha.2`；详见 [W33 实现说明](w33-ui-palettes.md)。
- `scripts/release/publish-release.ps1` 已改为默认发布到 `wangweiyu666/DSlocal-task-manager`，并允许显式传入仓库目标。
