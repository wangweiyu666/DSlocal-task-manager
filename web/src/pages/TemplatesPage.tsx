...
export function TemplatesPage() {
  ...
  const editTemplate = (template: TemplateRecord) => setEditing({ ...template, ...normalizeEditableSteps(template.id, template.name, template.steps, template.execution) });
