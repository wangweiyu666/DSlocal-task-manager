...
export function SettingsPage() {
  ...
  const timeZoneValid = useMemo(() => {
    ...
    try { new Intl.DateTimeFormat("en", { timeZone: form.timeZone }).format(); return true; } catch { return false; }
  }, [form?.timeZone]);
